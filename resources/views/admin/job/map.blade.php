                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                @foreach ($prodis as $prodi)
                                    {{-- button --}}
                                    <a href="{{ route('jobs.map', ['prodi_id' => $prodi->id]) }}" class="btn btn-primary btn-sm btn-block mb-4">
                                        {{ $prodi->name }}
                                    </a>
                                    <br>
                                @endforeach
                                <a href="{{ route('jobs.map') }}" class="btn btn-outline-primary btn-sm btn-block mb-4">
